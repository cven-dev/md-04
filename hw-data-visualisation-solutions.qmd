---
title: "Homework Exercise - Data Visualisation (Solutions)"
format: html
self-contained: true
execute:
  echo: true
...
1.  Install the `sf` and `rnaturalearth` R Packages if you have not yet installed them. **Hint: Use the `install.packages()` function in the Console.**

2.  Load the R Packages `sf` and `rnaturalearth` using the `library()` function at the beginning of this file alongside the other loaded R Packages
...
3.  Write a meaningful commit message (e.g. "Completed week 4 data visualization homework") in the **Commit message** box
4.  Click **Commit**. Note that every commit needs to have a commit message associated with it.
5.  Click **Push** to send your changes to GitHub.
6.  Go to your md-04-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is time to complete the assignment by opening an issue on your md-04-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your md-04-USERNAME GitHub repo (where USERNAME is your GitHub username).
