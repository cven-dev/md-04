...
All functions that adapt the scale start with `scale_` followed by the aesthetic to be adapted, e.g. `x_`, and then followed by the type of variable, e.g. `continuous`. So to adapt a continuous scale on an x-axis, the function to use is: `scale_x_continuous()`
...
![Municipal solid waste generation per capita versus GDP per capita, coloured by income group.](figs/plot-waste-generation-gdp.png){#fig-plot-waste-gdp}
...
And to learn more about using Quarto for scholarly writing: https://quarto.org/docs/authoring/title-blocks.html

# Stage, Commit & Push to GitHub

1.  Open the Git pane in RStudio. It's in the top right corner in a separate tab.
2.  **Stage** your changes by checking appropriate box next to all files (if you select one file with your mouse, you can then highlight them all with Ctrl + A on your keyboard and check all boxes)
3.  Write a meaningful commit message (e.g. "Completed week 4 live coding exercise") in the **Commit message** box
